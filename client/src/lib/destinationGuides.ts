...
export const destinationGuides: DestinationGuide[] = [
  ...
  },
  {
    ...
    travelType: "mexico",
    idealFor: ["A sun-filled couples’ trip", "A multigenerational stay with simple logistics", "A celebration that pairs relaxation with a sense of place"],
  ...
  },
  {
    ...
    idealFor: ["A milestone birthday or family gathering", "Friends traveling together without logistical stress", "A wedding-related or celebration-focused escape"],
  ...
  },
  {
    ...
    moments: ["A sailing selected around how you like to spend your time", "Cabin, itinerary, and shore moments considered together", "A pre- or post-cruise stay that rounds out the journey"],
