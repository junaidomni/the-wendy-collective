...
const principles = [
  ...
  ["03", "Handle the details", "A well-planned journey lets you stay present. From the first shortlist through travel day, the details deserve close attention."],
];
