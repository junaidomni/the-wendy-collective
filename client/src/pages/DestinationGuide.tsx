...
export default function DestinationGuide() {
  ...
  return <SiteShell darkHeader>
    <section className="guide-hero">
      ...
      <div className="page-wrap guide-hero__content"><p className="eyebrow">{guide.label}</p><h1 className="display">{guide.title} <em>{guide.italic}</em></h1><p>{guide.summary}</p><Link href={guideInquiryHref(guide)} className="button-link">{guide.inquiryLabel} <span aria-hidden="true">↗</span></Link></div>
    </section>
