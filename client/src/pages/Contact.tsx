...
type TripForm = {
  firstName: string; lastName: string; email: string; phone: string; travelType: TravelType; destinations: string; travelTiming: string; dateFlexibility: "exact" | "flexible" | "unsure"; budget: string; groupSize: string; priorities: string;
};
